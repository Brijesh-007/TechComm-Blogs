...
export default function SignIn({ posts }: Props) {
  console.log(posts);
  return (
    <Fragment>
      <ScrollButton />
      ...
      <section className="h-screen">
        <div className="container px-6 py-6 h-full items-center">
          <div className="flex justify-center items-center flex-wrap h-full text-gray-800">
            <div className="md:w-8/12 lg:w-5/12 dark:bg-slate-700 mx-auto p-4 rounded-md border-2">
              <div className="text-center py-3 text-4xl font-semibold rounded-md mb-4 dark:text-white ">
                <p>Sign In</p>
              </div>
              <form>
                {/* <!-- Email input --> */}
